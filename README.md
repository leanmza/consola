Proyecto final progamación I, hecho en Java con spring boot para la persistencia en la bd.

El objetivo del proyecto es gestionar turnos, pacientes y doctores dentro de una clínica odontológica.  
El sistema permite mantener el registro de los doctores, sus especialidades, horarios de atención y los turnos asignados a cada paciente.
